...
public class TestBloomFilter {
    ...
    public void testInsert5() {
        ...
        assertTrue("Number 5 is in shared.BloomFilter.shared.BloomFilter after it was added", isInBloomfilter);
    }
    ...
    /**
     * Tests if the function readInBloomFilter of Class shared.BloomFilter is functioning properly
     */
    @Test
    public void testReadInBloomFilter() {
        //fill client bloom-filter
        bloomFilter.emptyBloomFilter();
        bloomFilter.add(5);
        bloomFilter.add(37);
