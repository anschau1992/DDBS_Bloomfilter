...
\end{equation}
This means, for every hash function we simply choose a and b randomly from their sets to create $h_{ab}$. We can use the proofs in the book to verify that this family of hash functions performs well.
